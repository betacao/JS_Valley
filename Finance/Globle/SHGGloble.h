...
/**
 ...
 @since 1.6.0
 */
- (void)requestUserVerifyStatusCompletion:(void (^)(BOOL state , NSString *auditState))completionblock showAlert:(BOOL)showAlert leftBlock:(void(^)())leftblock failString:(NSString *)string;
