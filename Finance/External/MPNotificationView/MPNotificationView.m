                                 ...
                                 pushId:(NSDictionary *)rid
{
    ...
    DDTapGestureRecognizer *gr = [[DDTapGestureRecognizer alloc] initWithTarget:notification
...
- (void) handleTap:(DDTapGestureRecognizer *)gestureRecognizer
{
    if (_tapBlock != nil)
    {
        _tapBlock(self);
...
//    }
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kMPNotificationViewTapReceivedNotification
                                                        object:gestureRecognizer.userInfo];
