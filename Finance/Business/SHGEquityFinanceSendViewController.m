...
- (NSDictionary *)firstDic
{
    ...
    dictionary = @{@"userId":UID, @"type": @"equityfinancing", @"contact": self.phoneNumTextField.text, @"financingStage":financingStage, @"investAmount": self.monenyTextField.text, @"area": self.areaSelectButton.titleLabel.text, @"industry": industry,@"title":self.nameTextField.text,@"companyName":self.companyNametextField.text};
    return dictionary;
}
- (void)addSdLayout
{
