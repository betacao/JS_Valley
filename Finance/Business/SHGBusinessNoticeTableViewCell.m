//
//  SHGBusinessNoticeTableViewCell.m
//  Finance
//
...
@end
@implementation SHGBusinessNoticeTableViewCell
...
@interface SHGBusinessImageTableViewCell()

@property (strong, nonatomic) UIButton *imageButton;//展示图片当数据中含有tipUrl的时候显示 然后隐藏其他全部控件
@end

@implementation SHGBusinessImageTableViewCell
...
@interface SHGBusinessLabelTableViewCell()
...
@implementation SHGBusinessLabelTableViewCell
