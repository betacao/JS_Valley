        ...
        [self uploadImage:^(BOOL success) {
            switch (((SHGEquityFinanceSendViewController *)weakSelf.superController).sendType) {
                case SHGEquityFinaceSendTypeNew:{
                    ...
                    NSDictionary *param = @{@"uid":UID, @"type": type,@"companyName":companyName, @"contact":contact, @"financingStage":financingStage, @"investAmount": investAmount, @"area": area,@"cityName":cityName, @"industry": industry,@"totalshareRate": weakSelf.retributionTextField.text, @"shortestquitYears":vestYears, @"detail": weakSelf.marketExplainTextView.text,@"photo": weakSelf.imageName,@"anonymous": anonymous,@"title": title, @"version":[SHGGloble sharedGloble].currentVersion};
                ...
                case SHGEquityFinaceSendTypeReSet:{
                    ...
                    NSDictionary *param = @{@"uid":UID,@"businessId":businessId, @"type": type, @"contact":contact,@"companyName":companyName, @"financingStage":financingStage, @"investAmount": investAmount, @"area": area, @"industry": industry,@"totalshareRate": weakSelf.retributionTextField.text, @"shortestquitYears":vestYears, @"detail": weakSelf.marketExplainTextView.text,@"photo": weakSelf.imageName,@"anonymous": anonymous,@"title": title, @"version":[SHGGloble sharedGloble].currentVersion};
                    NSLog(@"%@",param);
...
- (void)btnBackClick:(id)sender
{
    for (UIViewController *controller in self.navigationController.viewControllers) {
        if ([controller isKindOfClass:[SHGEquityFinanceSendViewController class]]) {
