...
- (void)addSdLayout
{
    ...
    .centerXIs(ceilf(SCREENWIDTH/8.0f))
    .widthIs(ceilf(SCREENWIDTH/4.0f))
    ...
    .topSpaceToView(self.inputView, MarginFactor(8.0f))
    .centerXIs(3 * ceilf(SCREENWIDTH/8.0f))
    .widthIs(ceilf(SCREENWIDTH/4))
    ...
    .topSpaceToView(self.inputView, MarginFactor(8.0f))
    .centerXIs(5 * ceilf(SCREENWIDTH/8.0f))
    .widthIs(ceilf(SCREENWIDTH/4.0f))
    ...
    .topSpaceToView(self.inputView, MarginFactor(8.0f))
    .centerXIs(7 * ceilf(SCREENWIDTH/8.0f))
    .widthIs(ceilf(SCREENWIDTH/4.0f))
...
- (void)loadInPutView
{
    if ([self.responseObject.createBy isEqualToString:UID]) {
        ...
        .topSpaceToView(self.inputView, MarginFactor(8.0f))
        .centerXIs(ceilf(SCREENWIDTH/3.0f))
        .widthIs(ceilf(SCREENWIDTH/4.0f))
        ...
        .topSpaceToView(self.inputView, MarginFactor(8.0f))
        .centerXIs(2 * ceilf(SCREENWIDTH/3.0f))
        .widthIs(ceilf(SCREENWIDTH/4.0f))
