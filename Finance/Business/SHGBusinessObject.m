...
+ (NSDictionary *)JSONKeyPathsByPropertyKey
{
    ...
    return @{@"investmoney":@"investmoney",@"complainNum":@"complainnum",@"isRefresh" : @"isrefresh", @"browseNum" : @"browsenum", @"modifyNum" : @"modifyNum", @"businessShow" : @"businessshow",@"createTime" : @"createtime", @"businessID" : @"businessid", @"modifyTime" : @"modifytime", @"anonymous" : @"anonymous",@"type":@"type",@"area":@"area",@"bondType":@"bondtype",@"shortestquitYears":@"shortestquityears",@"clarifyingWay":@"clarifyingway",@"contact":@"contact",@"detail":@"detail", @"fundUsetime":@"fundusetime", @"highestRate":@"highestrate",@"industry":@"industry",@"investAmount":@"investamount", @"investModel":@"investmodel", @"title":@"title", @"uid":@"uid", @"photo":@"photo",@"businessType":@"businesstype",@"clarifyingRequire":@"clarifyingrequire",@"lowestPaybackRate":@"lowestpaybackrate",@"financingStage":@"financingstage",@"fundSource":@"fundsource",@"moneysideType":@"moneysidetype",@"totalshareRate":@"totalsharerate",@"vestYears":@"vestyears", @"userState":@"loginuserstate", @"middleContent":@"middlecontent", @"isDeleted":@"isdeleted", @"isCollection":@"iscollected", @"createBy":@"createby", @"commentList":@"commentlist", @"realName":@"realname", @"company":@"company",@"businessCompanyName":@"businessCompanyName", @"status":@"status", @"headImageUrl":@"headimageurl", @"url":@"url", @"businessTitle":@"businesstitle", @"bpnameList":@"bpnamelist", @"bppathList":@"bppathlist",@"companyDetail":@"companydetail",@"auditState":@"auditstate",@"businessauditstate":@"businessauditstate",@"cityName":@"cityname",@"position":@"position"};
