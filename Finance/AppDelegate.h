...
#import "WXApi.h"
@interface AppDelegate : UIResponder <UIApplicationDelegate,BPushDelegate,IChatManagerDelegate,MFMessageComposeViewControllerDelegate,WeiboSDKDelegate,UIAlertViewDelegate,WXApiDelegate>
{
