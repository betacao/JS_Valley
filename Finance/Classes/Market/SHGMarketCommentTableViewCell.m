//
//  SHGMarketCommentTableViewCell.m
//  Finance
//
...
@interface SHGMarketCommentTableViewCell ()

@property (weak, nonatomic) IBOutlet UIView *bgView;
@property (assign, nonatomic) SHGMarketCommentType commentType;

@end

@implementation SHGMarketCommentTableViewCell

- (void)awakeFromNib
{
}

- (void)loadUIWithObj:(SHGMarketCommentObject *)object commentType:(SHGMarketCommentType)type
{
    self.commentType = type;
    CGRect frame = CGRectZero;
    switch (type) {
        case SHGMarketCommentTypeFirst:
            ...
            break;
        case SHGMarketCommentTypeNormal:
