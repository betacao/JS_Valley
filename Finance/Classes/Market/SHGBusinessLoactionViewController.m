...
#define kLocationButtonLeftMargin (SCREENWIDTH - 3 * MarginFactor(111.0f) - 2 * MarginFactor(12.0f)) / 2.0f
...
- (void)initView
{
    ...
    [self.nationWideButton setBackgroundImage:[UIImage imageNamed:@"locationButtonBg"] forState:UIControlStateNormal];
    [self.nationWideButton setBackgroundImage:[UIImage imageNamed:@"locationButtonBgHigh"] forState:UIControlStateHighlighted];
    [self.nationWideButton setTitleColor:Color(@"161616") forState:UIControlStateNormal];
    [self.nationWideButton setTitleColor:Color(@"f33300") forState:UIControlStateHighlighted];
    ...
    {
        for (int i = 0; i < [[[self.provinces objectAtIndex:j] objectForKey:@"areas"] count]; i ++)
        {
            ...
            [button setBackgroundImage:[UIImage imageNamed:@"locationButtonBg"] forState:UIControlStateNormal];
            [button setBackgroundImage:[UIImage imageNamed:@"locationButtonBgHigh"] forState:UIControlStateHighlighted];
            [button setTitleColor:Color(@"161616") forState:UIControlStateNormal];
            [button setTitleColor:Color(@"f33300") forState:UIControlStateHighlighted];
