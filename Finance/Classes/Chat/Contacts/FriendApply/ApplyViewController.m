...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick event:@"ApplyViewController" label:@"onClick"];
...
- (void)loadDataSourceFromLocalDB
{
    ...
    if(loginName && [loginName length] > 0)
    {
        ...
        for (ApplyEntity *appEntiy in applyArray) {
            if (!IsStrEmpty(appEntiy.groupId)) {
                [addArr addObject:appEntiy];
            }
        }
