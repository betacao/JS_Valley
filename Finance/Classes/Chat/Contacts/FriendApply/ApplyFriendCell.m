...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        // Initialization code
        _headerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(16, 10, 40, 40)];
...
//        _headerImageView.layer.cornerRadius = 5.0;
        ...
        [_addButton setBackgroundColor:[UIColor colorWithRed:245 / 255.0 green:93 / 255.0 blue:88 / 255.0 alpha:1.0]];
        ...
        [_refuseButton setBackgroundColor:[UIColor colorWithRed:143 / 255.0 green:143 / 255.0 blue:143 / 255.0 alpha:1.0]];
...
-(void)layoutSubviews
{
    ...
    _addButton.frame = CGRectMake(self.contentView.frame.size.width - 120, (self.contentView.frame.size.height - 30) / 2, 50, 30);
    _refuseButton.frame = CGRectMake(self.contentView.frame.size.width - 60, (self.contentView.frame.size.height - 30) / 2, 50, 30);
