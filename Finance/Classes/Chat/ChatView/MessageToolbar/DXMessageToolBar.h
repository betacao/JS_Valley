...
#define kInputTextViewMinHeight 30.0f
#define kInputTextViewMaxHeight 200.0f
#define kHorizontalPadding MarginFactor(12.0f)
#define kVerticalPadding MarginFactor(10.0f)
