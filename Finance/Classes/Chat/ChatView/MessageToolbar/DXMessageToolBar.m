...
- (void)setupSubviews
{
    ...
    if (!self.moreView) {
        ...
        self.moreView.backgroundColor =  [UIColor colorWithRed:238/255.0 green:238/255.0 blue:238/255.0 alpha:1.0f];
    ...
    if (!self.faceView) {
        ...
        self.faceView.backgroundColor =  [UIColor colorWithRed:238/255.0 green:238/255.0 blue:238/255.0 alpha:1.0f];
