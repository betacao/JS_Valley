...
#define MENU_POINTER_RECT       CGRectMake(frame.origin.x+80, frame.origin.y, 23, 11)

#define CONTAINER_BG_COLOR      RGBA(229, 229, 229, 0.1f)
...
//        menuPointerView.backgroundColor=[UIColor redColor];
...
//        menuItemsTableView.backgroundView = bgView;
        menuItemsTableView.backgroundColor=[UIColor colorWithRed:229/255.0 green:229/255.0 blue:229/255.0 alpha:1.0f];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        [cell.textLabel setTextColor:[UIColor colorWithRed:129/255.0 green:129/255.0 blue:129/255.0 alpha:1.0f]];
