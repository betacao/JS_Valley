...
REGULAREXPRESSION(PhoneNumerRegularExpression, @"(((13[0-9])|(15([0|1|2|3|5|6|7|8|9]))|(14([5|7]))|(17([0|5|6|7|8]))|(18[0-9]))\\d{8})|(0\\d{2}-\\d{8})|(0\\d{3}-\\d{8})|(((13[0-9])|(15([0|1|2|3|5|6|7|8|9]))|(14([5|7]))|(17([0|5|6|7|8]))|(18[0-9]))-\\d{4}-\\d{4})")
...
#define kURLEXPRESSION @"((http[s]{0,1}|ftp)://[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)|(www.[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)"
...
- (void)setText:(id)text
{
    ...
    NSMutableAttributedString *mutableAttributedString = [self checkAndSetEmoji:text];
...
- (NSMutableAttributedString *)checkAndSetEmoji:(id)text
{
    ...
    if (self.disableEmoji) {
        ...
        if([text isKindOfClass:[NSString class]]){
            ...
            [regularExpression enumerateMatchesInString:text options:0 range:NSMakeRange(0, newText.length) usingBlock:^(NSTextCheckingResult * _Nullable result, NSMatchingFlags flags, BOOL * _Nonnull stop) {
            ...
            for(NSInteger i = 0;i < results.count;i++){
                ...
                [newText insertString:@"/:url" atIndex:result.range.location + location];
                location += 5;
            }

            mutableAttributedString = [self mutableAttributeStringWithEmojiText:[[NSAttributedString alloc] initWithString:newText]];
