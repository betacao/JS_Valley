...
-(CGFloat)fetchCellHeight
{
    ...
    if (IsStrEmpty(self.detail)){
        ...
        globleLabel.font = [UIFont fontWithName:@"Hiragino Sans" size:14.0f];
    ...
    if (num == 0) {
        ...
        for (int i = 0; i < num; i ++){
            ...
            CGFloat height = [text sizeForFont:[UIFont fontWithName:@"Hiragino Sans" size:14.0f] constrainedToSize:CGSizeMake(SCREENWIDTH - (kPhotoViewLeftMargin + kPhotoViewRightMargin) - CELLRIGHT_COMMENT_WIDTH, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping].height;
