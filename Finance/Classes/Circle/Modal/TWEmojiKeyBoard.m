...
#define  BTN_NORMAL_ARRAY @[@"emoji_recent_n",@"emoji_face_n",@"nil",@"nil",@"nil",@"emoji_backspace_n"]

#define  BTN_SELECT_ARRAY @[@"emoji_recent_s",@"emoji_face_s",@"nil",@"nil",@"nil",@"emoji_backspace_s"]
